                    ...
                    <div class="card-body" style="width: mac-content;display: flex;">
                        <div class="row text-center" style="display: block;z-index: 44444;">
                            ...
                            <a href="{{ route('admin.kereta.index') }}">
                                ...
                                <p id="kereta">Infrastuktur Kereta <br>({{ count($kereta) }})</p>
                            </div>
                            <div class="col">
                            <a href="{{ route('admin.bandara.index') }}">
                                <img src="{{ asset('backend/img/pembangunan/3_infrastruktur kebandarudaraan.jpg') }}" alt="" width="40" height="40">
                            </a>
                                <p id="bandara">Infrastuktur Bandara <br>({{ count($bandara) }})</p>
                            </div>
                            <div class="col">
                            ...
                            <a href="{{ route('admin.minyak.index') }}">
                                ...
                                <p id="minyak">Minyak dan Gas Bumi <br>({{ count($minyak) }})</p>
                            </div>
                        </div>
                        <p id="kecamatan">Kecamatan : </p>
                        <section class="map">
        ...
        function yellow() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#kereta').html('Infrastuktur Kereta <br>('+ data[1].length +')')
                    $('#bandara').html('Infrastuktur Bandara <br>('+ data[2].length +')')
                    $('#telekomunikasi').html('Infrastuktur <br> Telekomunikasi <br>('+ data[3].length +')')
                    $('#pelabuhan').html('Infrastuktur Pelabuhan <br>('+ data[4].length +')')
                    $('#listrik').html('Ketenagalistrikan <br>('+ data[5].length +')')
                    $('#energi').html('Energi Alternatif <br>('+ data[6].length+ ')')
                    $('#minyak').html('Minyak dan Gas Bumi <br>('+ data[7].length +')')

                    $('#ilmu').html('Ilmu Pengetahuan Teknologi <Br>('+ data[8].length +')')
