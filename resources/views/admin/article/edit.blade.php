                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <input type="hidden" id="book_id" value="{{ $articles->id }}">
                                    <div class="text-danger" id="valid-type">{{ $errors->first('type') }}</div>
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label for="title">Title<sup class="text-danger">*</sup></label>
                                                <input type="text" class="form-control form-control-sm @error('title') is-invalid @enderror" name="title" id="title" value="@error('title'){{ old('title') }}@else{{ $articles->title }}@enderror" placeholder="Input here...">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="summernote form-control form-control-sm @error('content') is-invalid @enderror" name="content" id="content" placeholder="Input here..." rows="5">@error('content'){{ old('content') }}@else{{ $articles->content }}@enderror</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <img src="{{ asset('/img/article/' . $articles->thumbnail) }}" class="img-thumbnail">
