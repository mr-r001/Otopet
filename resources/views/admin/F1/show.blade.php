...
<body>
    ...
    <div class="wrap-content2">
        <div class="alamat" style="width: 100vw;margin-bottom: 40px;margin-left: 40px;display: flex;justify-content: space-between;align-items: center;margin-top: -30px;">
        ...
        <br>
        <table class="table tbl3" style="width: 111vw;margin-top: 0px;transform: scale(1.15);margin-left: 30px;">
            <thead>
              <tr>
                <th scope="col">No</th>
