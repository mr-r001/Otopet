...
<body>
    ...
    <section class="hero">
        ...
        <div class="wrap-content">
            ...
            <table class="table tg">
                ...
                <tbody>
                  <tr style="border-bottom: none;border-top: none;">
                    ...
                    <td style="border-bottom: none;">1. Nabire</td>
                    <td>1. Bumiwonoreji</td>
                    <td>1000 orang</td>
                  </tr>
            ...
            <p>Berdasarkan tabel tersebut, jumlah dukungan bakal pasangan calon perseorangan adalah :</p>
            <br>
