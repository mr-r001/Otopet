...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backend/css/model.css') }}">
</head>
<body>
    <section class="hero">
    ...
    <div class="wrap-content2">
        ...
        <p>Provinsi <span class="titik">:</span> <span style="font-weight: bold;position: absolute;left: 20vw">PAPUA</span></p>
