                            ...
                            <div class="card card-success">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label for="nama">Nama Organisasi Kemasyarakatan</label>
                                                <select class="select2 form-control form-control-sm @error('nama') is-invalid @enderror" name="nama" id="nama">
                                                    ...
                                                    @foreach ($organisasis as $organisasi )
                                                        <option value="{{ $organisasi->id }}" {{ old('nama') == $organisasi->id || $data->organisasi_id == $organisasi->id ? 'selected' : '' }}>{{ $organisasi->nama }}</option>
                                                    @endforeach
                                                </select>
